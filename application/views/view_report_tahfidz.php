        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <div class="row">
                        <form action="<?php echo site_url('report/tahfidz') ?>" method="get">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if ($data_tahfidz->num_rows() >= 0) { ?>
                ...
                <?php if ($data_tahfidz->num_rows() > 0) { ?>
                    <div class="callout callout-success">
                        <h4><i class="icon fa fa-fw fa-table"></i>Laporan Tahfidz <?php echo $nama_mushrif ?>, Periode <?php echo tgl_indo(date_to_eng($tgl_mulai)) ?> Sampai <?php echo tgl_indo(date_to_eng($tgl_akhir)) ?></h4>
                    </div>
                    <div class="box-body table-responsive">
                        <table id="table" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($data_tahfidz->result() as $data) { ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        ...
                                        <td><?php echo $data->total_baris ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>

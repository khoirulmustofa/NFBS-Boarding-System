            ...
            <div class="box box-primary">
                ...
                <?php if ($data_absensi_tahfidz->num_rows() > 0) { ?>
                    <div class="callout callout-success">
                        <h4><i class="icon fa fa-fw fa-table"></i>Laporan Absensi Tahfidz <?php echo $nama_mushrif ?>, Periode <?php echo tgl_indo(date_to_eng($tgl_mulai)) ?> Sampai <?php echo tgl_indo(date_to_eng($tgl_akhir)) ?></h4>
                    </div>

        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-1">
                            <a class="btn btn-success" href="<?php echo site_url('mushrif_tahfidz/create') ?>">Tambah</a>
                        </div>
                        <div class="col-md-7">

                        </div>
                        <div class="col-md-4 text-right">
                            <form action="<?php echo site_url('mushrif_tahfidz'); ?>" class="form-inline" method="get">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        if ($cari != '') {
                                        ?>
                                            <a href="<?php echo site_url('mushrif_tahfidz'); ?>" class="btn btn-default">Reset</a>
                                        <?php
                                        }
                                        ?>
                ...
                <div class="box-body table-responsive">
                    <table id="table" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Mushrif Tahfidz</th>
                                <th>Status</th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($mushrif_tahfidz_data as $data) { ?>
                                <tr>
                                    <td><?php echo ++$start ?></td>
                                    <td><?php echo $data->users_nama_lengkap ?></td>
                                    <td>
                                        <?php if ($data->mushrif_tahfidz_status == 'Y') { ?>
